...
#pragma warning disable 0649
        ...
        [Header("Properties")] [SerializeField] [HideInInspector]
        private bool singleton = true;

        // Minimum height of the console window
        [SerializeField] [HideInInspector] private float minimumHeight = 200f;
        ...
        [SerializeField] [HideInInspector] private bool startMinimized;

        [SerializeField] [HideInInspector] private bool toggleWithKey;

        [SerializeField] [HideInInspector] private KeyCode toggleKey = KeyCode.BackQuote;

        [SerializeField] [HideInInspector] private bool enableSearchbar = true;

        [SerializeField] [HideInInspector] private float topSearchbarMinWidth = 360f;

        // Should command input field be cleared after pressing Enter
        [SerializeField] [HideInInspector] private bool clearCommandAfterExecution = true;

        [SerializeField] [HideInInspector] private int commandHistorySize = 15;

        [SerializeField] [HideInInspector] private bool receiveLogcatLogsInAndroid;

        [SerializeField] [HideInInspector] private string logcatArguments;

        [SerializeField] private bool avoidScreenCutout = true;
